...
import { PHOTO_WORKER_URL, PHOTO_UPLOAD_SECRET, FIELD_RESUME_TOKEN } from './config.js?v=242';
import { uploadPhotoToSupabase, verifyInspectionStatus } from './supabase-photos.js?v=242';
import { getInspection, getSyncStatus, setSyncStatus, setLastSaveText,
         ...
         getBestCloudSyncAt } from './state.js?v=242';
import { scheduleSave } from './storage.js?v=242';
import { buildExportJSON, stripPhotosFromExport, extractAllPhotosFromExport } from './inspection.js?v=242';
import { ensureInspectionWorkspace, mergeRemoteInspection } from './findings.js?v=242';
...
async function uploadPhotosViaSupabase(photosToUpload, exportData, inspection) {
  ...
  try {
    const { checkSupabaseConfirmed } = await import('./supabase-photos.js?v=242');
