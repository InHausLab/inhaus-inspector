...
import { PHOTO_WORKER_URL, PHOTO_UPLOAD_SECRET, FIELD_RESUME_TOKEN } from './config.js?v=255';
import { uploadPhotoToSupabase, verifyInspectionStatus } from './supabase-photos.js?v=255';
import { getInspection, getSyncStatus, setSyncStatus, setLastSaveText,
         ...
         getBestCloudSyncAt } from './state.js?v=255';
import { scheduleSave } from './storage.js?v=255';
import { buildExportJSON, stripPhotosFromExport, extractAllPhotosFromExport } from './inspection.js?v=255';
import { ensureInspectionWorkspace, mergeRemoteInspection } from './findings.js?v=255';
...
async function uploadPhotosViaSupabase(photosToUpload, exportData, inspection) {
  ...
  try {
    const { checkSupabaseConfirmed } = await import('./supabase-photos.js?v=255');
