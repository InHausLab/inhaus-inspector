...
import { PHOTO_WORKER_URL, PHOTO_UPLOAD_SECRET, FIELD_RESUME_TOKEN } from './config.js?v=259';
import { uploadPhotoToSupabase, verifyInspectionStatus } from './supabase-photos.js?v=259';
import { getInspection, getSyncStatus, setSyncStatus, setLastSaveText,
         ...
         getBestCloudSyncAt } from './state.js?v=259';
import { scheduleSave } from './storage.js?v=259';
import { buildExportJSON, stripPhotosFromExport, extractAllPhotosFromExport } from './inspection.js?v=259';
import { ensureInspectionWorkspace, mergeRemoteInspection } from './findings.js?v=259';
...
async function uploadPhotosViaSupabase(photosToUpload, exportData, inspection) {
  ...
  try {
    const { checkSupabaseConfirmed } = await import('./supabase-photos.js?v=259');
