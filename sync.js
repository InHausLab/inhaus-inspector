...
import { GOOGLE_SCRIPT_URL, SYNC_SECRET, LEGACY_SYNC_SECRET, FIELD_RESUME_TOKEN, USE_SUPABASE_PHOTOS } from './config.js?v=166';
import { uploadPhotoToSupabase, mirrorPhotosToDrive, verifyInspectionStatus } from './supabase-photos.js?v=166';
import { getInspection, getSyncStatus, setSyncStatus, setLastSaveText,
         ...
         getBestCloudSyncAt } from './state.js?v=166';
import { scheduleSave } from './storage.js?v=166';
import { buildExportJSON, stripPhotosFromExport, extractAllPhotosFromExport } from './inspection.js?v=166';
import { ensureInspectionWorkspace, mergeRemoteInspection } from './findings.js?v=166';
...
async function uploadPhotosViaSupabase(photosToUpload, exportData, inspection) {
  ...
  try {
    const { checkSupabaseConfirmed } = await import('./supabase-photos.js?v=166');
