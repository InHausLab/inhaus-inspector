...
import { PHOTO_WORKER_URL, PHOTO_UPLOAD_SECRET, FIELD_RESUME_TOKEN } from './config.js?v=235';
import { uploadPhotoToSupabase, verifyInspectionStatus } from './supabase-photos.js?v=235';
import { getInspection, getSyncStatus, setSyncStatus, setLastSaveText,
         ...
         getBestCloudSyncAt } from './state.js?v=235';
import { scheduleSave } from './storage.js?v=235';
import { buildExportJSON, stripPhotosFromExport, extractAllPhotosFromExport } from './inspection.js?v=235';
import { ensureInspectionWorkspace, mergeRemoteInspection } from './findings.js?v=235';
...
async function uploadPhotosViaSupabase(photosToUpload, exportData, inspection) {
  ...
  try {
    const { checkSupabaseConfirmed } = await import('./supabase-photos.js?v=235');
