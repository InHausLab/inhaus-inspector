...
**GO for a supervised field inspection after the phone shows v179.**
...
- Netlify and Vercel serve the same v179 cache, database guard, header controls, and cache-reset guidance.
...
3. Confirm the gray version badge says **v179**.
