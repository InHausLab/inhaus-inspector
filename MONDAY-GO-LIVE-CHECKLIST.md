...
**GO for a supervised field inspection after the phone shows v172.**
...
- Netlify and Vercel serve the same v172 cache, database guard, header controls, and cache-reset guidance.
...
3. Confirm the gray version badge says **v172**.
