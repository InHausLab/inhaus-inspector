...
**GO for a supervised field inspection after the phone shows v177.**
...
- Netlify and Vercel serve the same v177 cache, database guard, header controls, and cache-reset guidance.
...
3. Confirm the gray version badge says **v177**.
